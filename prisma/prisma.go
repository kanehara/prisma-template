...
func (client *Client) User(params UserWhereUniqueInput) *UserExec {
	ret := client.Client.GetOne(
		...
		"user",
		[]string{"id", "firstName", "lastName", "email", "password", "resetToken", "resetTokenExpiry", "createdAt", "updatedAt"})
...
const (
	...
	UserOrderByInputResetTokenAsc        UserOrderByInput = "resetToken_ASC"
	UserOrderByInputResetTokenDesc       UserOrderByInput = "resetToken_DESC"
	UserOrderByInputResetTokenExpiryAsc  UserOrderByInput = "resetTokenExpiry_ASC"
	UserOrderByInputResetTokenExpiryDesc UserOrderByInput = "resetTokenExpiry_DESC"
...
type UserCreateInput struct {
	...
	ResetTokenExpiry *string `json:"resetTokenExpiry,omitempty"`
}
...
type UserWhereInput struct {
	...
	ResetToken              *string          `json:"resetToken,omitempty"`
	ResetTokenNot           *string          `json:"resetToken_not,omitempty"`
	ResetTokenIn            []string         `json:"resetToken_in,omitempty"`
	ResetTokenNotIn         []string         `json:"resetToken_not_in,omitempty"`
	ResetTokenLt            *string          `json:"resetToken_lt,omitempty"`
	ResetTokenLte           *string          `json:"resetToken_lte,omitempty"`
	ResetTokenGt            *string          `json:"resetToken_gt,omitempty"`
	ResetTokenGte           *string          `json:"resetToken_gte,omitempty"`
	ResetTokenContains      *string          `json:"resetToken_contains,omitempty"`
	ResetTokenNotContains   *string          `json:"resetToken_not_contains,omitempty"`
	ResetTokenStartsWith    *string          `json:"resetToken_starts_with,omitempty"`
	ResetTokenNotStartsWith *string          `json:"resetToken_not_starts_with,omitempty"`
	ResetTokenEndsWith      *string          `json:"resetToken_ends_with,omitempty"`
	ResetTokenNotEndsWith   *string          `json:"resetToken_not_ends_with,omitempty"`
	ResetTokenExpiry        *string          `json:"resetTokenExpiry,omitempty"`
	ResetTokenExpiryNot     *string          `json:"resetTokenExpiry_not,omitempty"`
	ResetTokenExpiryIn      []string         `json:"resetTokenExpiry_in,omitempty"`
	ResetTokenExpiryNotIn   []string         `json:"resetTokenExpiry_not_in,omitempty"`
	ResetTokenExpiryLt      *string          `json:"resetTokenExpiry_lt,omitempty"`
	ResetTokenExpiryLte     *string          `json:"resetTokenExpiry_lte,omitempty"`
	ResetTokenExpiryGt      *string          `json:"resetTokenExpiry_gt,omitempty"`
	ResetTokenExpiryGte     *string          `json:"resetTokenExpiry_gte,omitempty"`
